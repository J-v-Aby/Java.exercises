...
public class Exercises {
   ...
   private static Student createNewStudent(String x, Integer y) {
    ...
    private static void exercise3() {
        ...
        List<String> studentNames = Arrays.asList("Alice", "Aragon", "Alex","Giulio");
        List<Integer> studentAges = Arrays.asList(23, 31, 38, 80);
        int sum=0;
        ...
        for (int i = 0; i < studentAges.size(); i++) {
            ...
            corse.students.add(student);
            sum += student.age;



        }
        System.out.println(corse.students);
        double media= sum/studentAges.size();
        System.out.println("media studenti "+ media);
    }
}
