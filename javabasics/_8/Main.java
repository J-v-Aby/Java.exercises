...
public class Main {
    ...
    private static void exercise1() {
        ...
        int myNumbers = Integer.valueOf( ourNumberStr);
        System.out.println(myNumbers);

        myNumbers += 2;
        System.out.println(myNumbers);

        String strNumber = String.valueOf(myNumbers);
    ...
    private static void exercise4() {
        ...
        String startStr = "5 ";
        // Write your code here
        int myNewInt = Integer.valueOf(startStr.trim());
        myNewInt *=2;
        String newString = String.valueOf(myNewInt);
        //System.out.println(newString);
        newString =newString+newString;
        System.out.println(newString);
        double firsDouble = Double.valueOf(newString);
        firsDouble /= 3.5;
        double secondDouble = Math.floor(firsDouble);
