...
public class Main {
    ...
    private static void exercise2() {
        ...
        System.out.println(", and my initial mane is = " + myInitial);
    }
    /**
    ...
    private static void exercise3() {
        System.out.println("\nExercise 3:");
        //write a boolean variable if you eat at lunch
        boolean hasEatenLunch = false;
        //write a double variable bout the price of lunch
        double lunchCost = 5.99;
        //print out it the price and if you are eating
