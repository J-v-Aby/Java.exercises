...
public class Exercises {
    ...
    private static void exercise2() {
        ...
        String userInputFileName = "test-file.txt";
           ...
           try{
            ...
            System.err.println("the user that the file could not be found");
            }
    }
    ...
    private static void exercise3() {
        ...
        try {
            ...
            System.err.println("the user that the input was not a valid integer");
        }
        ...
        String num2AsString = "0.0";
         try{
            System.out.println(num1/Integer.parseInt(num2AsString));
             ...
             System.err.println("DivideByZeroException");
         }
