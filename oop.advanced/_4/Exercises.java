package javabasics._2.oop.advanced._4;
...
public class Exercises {
    ...
    private static void exercise3() {
        ...
        try {
            // Your code here
            String stringaCodice = Files.readString(MY_PATH);
            String [] arr= stringaCodice.split("\n");
...
//
    // non capisco perche il terminale si comporta in due modi differenti tra file e folder
//ex: il primo esercizio non funziona se decommento il creatore di file, perche non avviene anche per il 5'?
       /*Files.createFile(MY_PATH);
         Files.writeString(MY_PATH, myString);*/
/* Files.createDirectories(myDirectoryPath);
         Files.writeString(PATH_IN_A_FOLDER, "Why am I in a folder?");*/
